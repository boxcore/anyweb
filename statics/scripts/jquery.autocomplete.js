...
$.Autocompleter.Select = function (options, input, select, config) {
	...
	function init() {
        ...
        element = options.element ? options.element : $("<div/>");
	...
	return {
		...
		show: function() {
			...
			element.css({
				...
				top: options.top ? options.top() : (offset.top + input.offsetHeight),
				left: options.left ? options.left() : offset.left
			}).show();
            if(options.scroll) {
                list.scrollTop(0);
//                list.css({
